...
CREATE DATABASE Alumnos  /*** Ejecutar primero esta línea y después copiar las demás lineas***/


-- Las siguientes líneas es para crear la tabla
CREATE TABLE Datos_Personales (
    Id_num INTEGER IDENTITY(1, 1), -- Con esto digo que empiece con el número 1 y vaya aumentando en 1 unidad
    Nombre VARCHAR(255) NOT NULL, -- NOT NULL para decir que no queremos valores nulos
    Correo VARCHAR(255),
    ...
    PRIMARY KEY (Id_num) -- Con esto especifico cuál es la llave primaria
);

-- Ahora meteremos los datos

-- La tabla donde meteremos los valores se llama "Datos_Personales", debemos separar con comas cada uno de los datos
-- Cada VALUE es un registro de la tabla
...
-- Ahora creamos las siguientes dos tablas: Ciudad y Region
CREATE TABLE Ciudad(
    Ciudad VARCHAR(255) NOT NULL,
